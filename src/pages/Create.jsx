import { Box, FormControl, FormLabel, Input, Spacer, FormHelperText, Textarea, Checkbox, Button, Flex, Container, SimpleGrid, Link } from "@chakra-ui/react";
      ...
      >
        ...
        >
          ...
          <Link
            ...
            p={2}              // Optional: adds some padding
            _hover={{          // Optional: adds hover effect
              color: "purple.500",
              textDecoration: "none"
            }}
          >Back to Home</Link>
